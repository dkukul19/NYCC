...
#SBATCH --time=1-0:0:0
#SBATCH --output=slurm_logs/policy_model-%J.log
...
LM_MODEL_NAME=../../../sft_output_2  #/kuacc/users/oince22/.cache/huggingface/hub/models--zhiqings--LLaVA-RLHF-7b-v1.5-224/snapshots/e209b5158897700108cefae829393079dbea0416/sft_model #LLaVA-RLHF-13b-v1.5-336/sft_model  #../../../sft_output_2 #LLaVA-RLHF-7b-v1.5-224/sft_model
